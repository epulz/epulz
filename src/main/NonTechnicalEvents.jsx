                ...
                <div className="swiper-slide-content">
                  <div>
                    ...
                    <p>
                      ...
                      where moments freeze, emotions speak, and visions paint a
                      thousand stories.
                    </p>
                    <Link
                      rel="noopener"
              ...
              <div className="swiper-slide">
                ...
                <div className="swiper-slide-content">
                  <div>
                    <h2>Bid Wars</h2>
                    <p>
                      Dive into the thrilling arena of Bid Wars, where
                      strategies clash, fortunes are made, and dreams of victory
                      are forged.
                    </p>
                    <Link className="show-more" to="/epulz/event/bid-wars">
                      <svg
                        fill="none"
                        stroke="currentColor"
                        strokeWidth="1.5"
