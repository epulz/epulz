...
function Hero() {
  ...
  useEffect(() => {
    let typed = new Typed(h1Ref.current, {
      strings: ["EPULZ", "2K24", "TPGIT"],
      typeSpeed: 100, // Adjust the typing speed (in milliseconds)
      backSpeed: 100, // Adjust the erasing speed (in milliseconds)
      loop: true,
      showCursor: true, // Set showCursor to false to hide the cursor
